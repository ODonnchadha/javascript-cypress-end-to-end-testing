describe('example-4', () => {
    ...
    it('should set header text to item name with double-click', () => {
    ...
    it('should display the correct number of selected checkboxes', () => {
        cy.get('[data-cy="box-2-checkboxes"] > :nth-child(1) input').check();
        cy.get('[data-cy="box-2-selected-count"]').invoke('text').should('equal', '1');
    });

    it('should display the correct name of the currently selected dropdown item', () => {
    ...
    it('should display the correct name of the most recent hovered item', () => {
